...
show_header() {
    ...
    echo "                   Apache Web Server with SSL Configuration"
    echo "============================================================================="
    echo -e "${NC}"
...
main() {
    ...
    while true; do
        ...
        case $choice in
            1) execute_script "$SCRIPT_DIR/install_ssl_only.sh" "Install Apache + SSL Only" ;;
            2) execute_script "$SCRIPT_DIR/fix_configs.sh" "Fix Apache Configurations" ;;
            0) 
