...
cat > "/root/installation_summary_${MAIN_DOMAIN}_${WP_SUBDIR}.txt" <<SUMMARY
WordPress Installation Summary (Subdirectory)
============================
Date: $(date)
...
WordPress Subdirectory: $WP_SUBDIR
WordPress URL: https://$MAIN_DOMAIN/$WP_SUBDIR
...
Important Paths:
--------------
Main Site Root: $MAIN_DIR
WordPress Root: $WP_DIR
WordPress Configuration: $WP_DIR/wp-config.php
WordPress .htaccess: $WP_DIR/.htaccess
...
chmod 600 "/root/installation_summary_${MAIN_DOMAIN}_${WP_SUBDIR}.txt"

echo "============================================="
echo "Installation Complete!"
echo "============================================="
echo "A complete summary has been saved to: /root/installation_summary_${MAIN_DOMAIN}_${WP_SUBDIR}.txt"
echo ""
echo "Quick Access Information:"
echo "------------------------"
echo "Main Website URL: https://$MAIN_DOMAIN"
echo "WordPress URL: https://$MAIN_DOMAIN/$WP_SUBDIR"
echo ""
...
# Create a phpinfo.php file for debugging
echo "<?php phpinfo(); ?>" > "$MAIN_DIR/info.php"
echo "NOTE: For security reasons, consider removing $MAIN_DIR/info.php after testing."