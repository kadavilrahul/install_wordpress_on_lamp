...
main() {
    check_root
    echo -e "${YELLOW}Backup/Restore Tool${NC}"
    echo "This tool handles backup and restore operations for WordPress sites and databases."
    echo
    echo "Launching backup_restore.sh..."
    bash "$(dirname "${BASH_SOURCE[0]}")/backup_restore.sh"
}
