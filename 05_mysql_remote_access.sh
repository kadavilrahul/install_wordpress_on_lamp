...
main() {
    check_root
    echo -e "${YELLOW}MySQL Remote Access Configuration${NC}"
    echo "This tool configures MySQL for remote connections."
    echo
    echo "Launching mysql_remote.sh..."
    bash "$(dirname "${BASH_SOURCE[0]}")/mysql_remote.sh"
}
